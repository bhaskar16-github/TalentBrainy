const state = {
      ...
      <div class='card shadow-sm task__card'>
        ...
        <div class='card-header d-flex justify-content-end task__card__header'>
            <button type='button' class='btn btn-outline-primary mr-1.5' name=${id} onclick="editTask.apply(this, arguments)">
             ...
             <button type='button' class='btn btn-outline-danger mr-1.5' onclick='deleteTask.apply(this, arguments)' >
  ...
  const deleteTask = (e) =>{
    ...
    const removeTask = state.taskList.filter(({id}) => id !== e.targetId);
    ...
    if(type === "BUTTON"){
      ...
      return e.parentNode.parentNode.parentNode.parentNode.parentNode.removeChild(
  ...
  const searchTask = (e) => {
    ...
    resultData.map(
      (cardData) =>
        taskContents.insertAdjacentHTML("beforeend", htmlTaskContent(cardData)) // for default Modal
      // taskContents.insertAdjacentHTML("beforeend", htmlModalContent(cardData)) // for large Modal
    );
  };